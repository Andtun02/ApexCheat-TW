...
#define OFFSET_WEAPON_NAME_INDEX	0x1824//m_weaponNameIndex 第二个		| 武器ID
#define OFFSET_LAST_CHARGE_LEVEL	0x17d0//m_lastChargeLevel			| 充能等级
#define OFFSET_GLOW_COLOR			0x01b8+ 0X18 // m_highlightParams + 0x18
#define OFFSET_GLOW_MODE			OFFSET_ITEM_GLOW + 0x4		// m_highlightFunctionBits + 0x4 || 辉光
