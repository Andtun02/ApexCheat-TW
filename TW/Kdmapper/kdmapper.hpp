...
namespace kdmapper
{
	...
	uint64_t MapDriver(HANDLE iqvw64e_device_handle, BYTE* data, ULONG64 param1 = 0, ULONG64 param2 = 0, bool destroyHeader = true, mapCallback callback = nullptr, NTSTATUS* exitCode = nullptr);
